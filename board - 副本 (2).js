class line_unit {
    constructor(col, row) {
        this.col = col;
        this.row = row;
        this.type1_pct = 0; //'0' means not possible, others means the percent of complete 5
        this.type2_pct = 0; //'0' means not possible, others means the percent of complete 5
        this.type3_pct = 0; //'0' means not possible, others means the percent of complete 5
        this.type4_pct = 0; //'0' means not possible, others means the percent of complete 5
        this.type5_pct = 0; //'0' means not possible, others means the percent of complete 5
    }
}
